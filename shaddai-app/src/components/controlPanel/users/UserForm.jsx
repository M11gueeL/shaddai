...
export default function UserForm({ user, onSubmit, onCancel, specialties, medicalColleges, loading }) {
  ...
  const validate = () => {
    const newErrors = {};
        ...
        if (!formData.email) {
            newErrors.email = 'Email es requerido para enviar invitación';
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-lg shadow-blue-500/30 text-sm font-medium hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-[1.02] ${loading ? 'opacity-75 cursor-wait' : ''}`}
                >
                  {loading ? (
