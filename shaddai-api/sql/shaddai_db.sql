...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2025 a las 03:05:56
...
(6, 8, 11, '2025-10-30', '12:35:00', 2, 1, 45, 'cancelada', 'primera_vez', 8, '2025-10-23 21:33:25', '2025-10-24 00:49:09'),
...
(5, 6, '', '', '', '2025-10-24 00:49:09', '2025-10-24 00:49:09'),
...
CREATE TABLE `doctor_schedules` (
  `id` int(11) NOT NULL,
  `doctor_id` int(11) NOT NULL,
  `day_of_week` tinyint(1) NOT NULL COMMENT '1=Lunes, 2=Martes, 3=Miércoles, 4=Jueves, 5=Viernes, 6=Sábado, 7=Domingo',
  `start_time` time NOT NULL,
  `end_time` time NOT NULL,
  `office_number` tinyint(1) DEFAULT NULL CHECK (`office_number` in (1,2,3)),
  `is_active` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Indica si el horario está activo',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci COMMENT='Horarios por defecto de los médicos - guía para agendar citas';
...
(23, 'juan', 'de la torre', '20989787', '2025-08-14', 'Masculino', 'Palo Negro', '04241231212', 'drjuan@gmail.com', '$2y$10$8MZrNLqe9SypSVixel9d8uVMCIaxPFb3a4/h070OxRs94eMdHc/a6', 8, '2025-08-11 02:11:27', '2025-10-23 15:48:30', 0);
...
('6ff96b007f46dc6811dbd1d60ea3a11d4d77b1bd32d4e07afc38b169e02fd9d8', 8, '::1', 'PostmanRuntime/7.49.0', '2025-10-25 04:07:35', 'active', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjgsImVtYWlsIjoibW9uYXN0ZXJpb21pZ3VlbGFuZ2VsODFAZ21haWwuY29tIiwicm9sZXMiOlsiYWRtaW4iXSwiaWF0IjoxNzYxMzQzNjU1LCJleHAiOjE3NjE0MzAwNTV9.ke4Uaz2QIi1PQ1mUPraLLNqeiSGCvGV3fNRBibNIIz0', NULL),
...
ALTER TABLE `doctor_schedules`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_doctor_day_time` (`doctor_id`,`day_of_week`,`start_time`,`end_time`),
...
--
ALTER TABLE `doctor_schedules`
  ADD CONSTRAINT `fk_doctor_schedules_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
